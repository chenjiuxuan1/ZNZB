...
import { renderBatchCheck } from "./views/batch-check.js?v=20260821-empty-runtime-copy-v5";
...
import { renderDsFailureLogs } from "./views/ds-failure-logs.js?v=20260902-ds-failure-evidence-v4";
import { renderAlertCenter } from "./views/alert-center.js?v=20260831-config31";
