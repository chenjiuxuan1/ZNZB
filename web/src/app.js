...
import { renderBatchCheck } from "./views/batch-check.js?v=20260819-patrol-restart-v4";
...
import { renderDsSchedulerUsage } from "./views/ds-scheduler-usage.js?v=20260820-usage-v5-dayfilter";
import { renderHiveScheduler } from "./views/hive-scheduler.js?v=20260811-hive-v1";
import { renderDsFailureLogs } from "./views/ds-failure-logs.js?v=20260820-retry-controls-v3";
