...
import { renderBatchCheck } from "./views/batch-check.js?v=20260725-async-v2";
import { renderFluctuationVisual } from "./views/fluctuation-visual.js?v=20260803-direct-chart-load";
