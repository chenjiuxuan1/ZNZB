...
const LEGACY_CAPABILITIES = Object.freeze({
  ...
  operations: freezeItems([
    { id: "connection-health", label: "连接状态", href: "/alerts/operations?focus=operations-health" },
    { id: "rule-sandbox", label: "规则沙盒与测试", href: "/sandbox" },
    { id: "script-preview", label: "脚本预览", href: "/alerts/operations?focus=script-release" },
    { id: "release-commit", label: "提交与发布", href: "/alerts/operations?focus=script-release" },
    { id: "audit-log", label: "检查与发布记录", href: "/alerts/operations?focus=operations-audit" },
  ]),
});
